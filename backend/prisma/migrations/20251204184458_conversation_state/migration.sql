...
INSERT INTO "new_Patient" ("consultReason", "doctorId", "fullName", "id", "insuranceProvider", "needsConsultReason", "needsInsurance", "needsName", "pendingSlotExpiresAt", "pendingSlotHumanLabel", "pendingSlotISO", "pendingSlotReason", "phone", "preferredDayISO", "preferredHour") SELECT "consultReason", "doctorId", "fullName", "id", "insuranceProvider", "needsConsultReason", "needsInsurance", "needsName", "pendingSlotExpiresAt", "pendingSlotHumanLabel", "pendingSlotISO", "pendingSlotReason", "phone", "preferredDayISO", "preferredHour" FROM "Patient";
DROP TABLE "Patient";
